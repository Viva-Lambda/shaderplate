...
void cubeShaderInit_proc3(Shader myShader) {
  myShader.useProgram();
...
int main() {
  ...
  GLFWwindow *window = glfwCreateWindow(
      WINWIDTH, WINHEIGHT, "Basic Phong Without Specular Map", NULL, NULL);
  ...
  // load shaders
  // cube shader
  std::string vertFileName_t = "phongNoSpec.vert";
  std::string fragFileName_t = "phongNoSpec.frag";
  ...
  cubeShaderInit_proc3(tangentCubeShader);
